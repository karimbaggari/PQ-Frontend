...
const StartupTestimonials = () => {
  ...
  <div class="mx-auto max-w-screen-xl px-4 md:px-8">
    <h2 class="mb-8 text-center text-2xl font-bold text-white md:mb-12 lg:text-3xl">What others say <span className='text-indigo-600'>about us</span></h2>

    <div class="grid gap-4 md:grid-cols-2 md:gap-8">
      <div class="flex flex-col items-center gap-4 rounded-lg bg-transparent border-2 border-indigo-600 px-8 py-6 md:gap-6">
