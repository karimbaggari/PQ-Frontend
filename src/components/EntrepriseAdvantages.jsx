...
const EntrepriseAdvantages = () => {
    return (
        <div class="bg-transparent py-6 sm:py-8 lg:py-12 w-full">
            <div class="w-full md:px-8">
                <div class="mb-10 md:mb-16">
                    <h2 class="mb-4 text-center text-2xl font-bold text-white md:mb-6 lg:text-3xl">Our competitive  <span className='text-indigo-600'>advantage</span></h2>
                ...
                <div class="bg-transparent flex w-full items-center justify-start gap-4">
                    <div class="w-full md:px-8 flex ">
                        <div class=" -mt-4 hidden w-full overflow-hidden rounded-lg bg-transparent shadow-sm lg:block">
                            <a href="#" class="block bg-transparent p-4 transition duration-100">
                                <div class="mb-1 flex items-end h-full gap-1.5">
                            ...
                            <div className='flex'>
                                <div class="m-6 mb-10 grid grid-cols-2 gap-8 h-[65%]">
...
export default EntrepriseAdvantages