        ...
        <div class="bg-transparent py-6 sm:py-8 lg:py-12">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <div class="grid gap-4 sm:grid-cols-2 md:gap-8 xl:grid-cols-3">
                    <div class="flex divide-x rounded-lg border bg-transparent">
                        ...
                        <div class="p-4 md:p-6">
                            ...
                            <p class="text-white">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</p>
                        </div>
                    </div>
                    <div class="flex divide-x rounded-lg border bg-transparent">
                        <div class="flex items-center p-2 text-indigo-500 md:p-4">
...
export default StartupAdvantages
